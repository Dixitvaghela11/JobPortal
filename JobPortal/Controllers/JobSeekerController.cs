    ...
    public class JobSeekerController : Controller
    {
        ...
        public ActionResult JobSeekerProfile()
        {
            try
            {
                ...
                var experience = jobSeekerRepository.GetExperienceDetails(seekerId);
        ...
        public ActionResult AddExperienceDetails()
        {
            return View();
        }

        [HttpPost]
        public ActionResult AddExperienceDetails(ExperienceDetails experienceDetails)
        {
            try
            {
                int id = (int)Session["SeekerId"];
                JobSeekerRepository jobSeekerRepository = new JobSeekerRepository();
                if (jobSeekerRepository.AddExperienceDetails(experienceDetails, id))
                {
        ...
        public ActionResult UpdateExperienceDetails(int id)
        {
            JobSeekerRepository jobSeekerRepository = new JobSeekerRepository();
            var experienceDetails = jobSeekerRepository.GetExperienceDetails(Convert.ToInt32(Session["SeekerId"])).Find(ed => ed.ExperienceId == id);
            return View(experienceDetails);
        }

        [HttpPost]
        public ActionResult UpdateExperienceDetails(ExperienceDetails experienceDetails)
        {
            JobSeekerRepository jobSeekerRepository = new JobSeekerRepository();
            try
            {
                if (jobSeekerRepository.UpdateExperienceDetails(experienceDetails))
                {
        ...
        [HttpGet]
        public ActionResult DeleteExperienceDetails(int id)
        {
            JobSeekerRepository jobSeekerRepository = new JobSeekerRepository();
            try
            {
                if (jobSeekerRepository.DeleteExperienceDetails(id))
                {
