...
namespace JobPortal.Repository
{
    public class JobSeekerRepository
    {
        ...
        public bool AddExperienceDetails(ExperienceDetails obj, int id)
        {
            try
            {
                connection();
                con.Open();
                obj.SeekerId = id;
                SqlCommand com = new SqlCommand("SP_CreateExperienceDetail", con);
                com.CommandType = CommandType.StoredProcedure;
        ...
        public bool UpdateExperienceDetails(ExperienceDetails obj)
        {
            try
            {
                connection();
                con.Open();
                SqlCommand com = new SqlCommand("SP_UpdateExperienceDetail", con);
                com.CommandType = CommandType.StoredProcedure;
                com.Parameters.AddWithValue("@ExperienceId", obj.ExperienceId);
                com.Parameters.AddWithValue("@CompanyName", obj.CompanyName);
                com.Parameters.AddWithValue("@JobTitle", obj.JobTitle);
                com.Parameters.AddWithValue("@Designation", obj.Designation);
                com.Parameters.AddWithValue("@Location", obj.Location);
        ...
        public bool DeleteExperienceDetails(int id)
        {
            try
            {
                connection();
                con.Open();
                SqlCommand com = new SqlCommand("SP_DeleteExperienceDetail", con);
                com.CommandType = CommandType.StoredProcedure;
                com.Parameters.AddWithValue("@ExperienceId", id);
                int i = com.ExecuteNonQuery();
                return i > 0;
            }
            finally
        ...
        public List<ExperienceDetails> GetExperienceDetails(int seekerId)
        {
            try
            {
                connection();
                SqlCommand com = new SqlCommand("SP_ReadExperienceDetails", con);
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    experienceDetails.Add(new ExperienceDetails()
                    {
